...
export default function DashboardDefault() {
  return (
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Active Users" count="18,800" percentage={57.4} extra="1,943" />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
      ...
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Total Order" count="18,800" percentage={27.4} extra="1,943" />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Revenue Generated" count="$35,078" percentage={27.4} extra="$20,395" />
      </Grid>
